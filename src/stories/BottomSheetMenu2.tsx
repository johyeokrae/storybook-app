...
const ContainerItemGroup = styled(motion.div)`
	display: flex;
	flex-wrap: wrap;
...
interface BottomSheetMenu2Props {
	handle?: boolean;
	onClick?: () => void;
	Image1?: string;
	Image1Text?: string;
...
export const BottomSheetMenu2 = ({
	handle = true,
	...props
}: BottomSheetMenu2Props) => {
				...
				>
					...
					<ContainerItemGroup>
						...
						<ItemGroup>
							...
							<ItemText>{props.Image2Text}</ItemText>
						</ItemGroup>
						<ItemGroup>
							<Item>
								<img
